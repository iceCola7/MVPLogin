...
import com.cxz.mvplogin.presenter.LoginPresenter;
 ...
 *
 * 7. 所谓的mvp，即是（model-处理业务逻辑（主要是数据读写，或者与后台通信（其实也是读写数据）），
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                attemptLogin();
                mLoginPresenter.didLogin(mEmailView.getText().toString().trim(),mPasswordView.getText().toString().trim());
            }
        });
